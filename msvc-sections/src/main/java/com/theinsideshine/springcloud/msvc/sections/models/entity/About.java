...
public class About {
    ...
    private List<AboutUser> aboutUsers;

    @Transient
    private List<User> users;

    public About() {
        aboutUsers = new ArrayList<>();
        users = new ArrayList<>();
    }
    ...
    public void removeAboutUser(AboutUser aboutUser) {
        aboutUsers.remove(aboutUser); // aca use la comparacion sobreescribir en cursoUsers el equals
    }
    public List<AboutUser> getAboutUsers() {
        return aboutUsers;
    }

    public void setAboutUsers(List<AboutUser> aboutUser) {
        this.aboutUsers = aboutUser;
    }
